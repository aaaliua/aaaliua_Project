...
import com.aaaliua.event.Event.NotifacationMSG;
import com.aaaliua.event.Event.RegisterEvent;
import com.aaaliua.itemwork.R;
import com.aaaliua.utils.Constant;
import com.aaaliua.utils.SmileUtils;
...
public class ChatHistoryAllActivity extends FragmentActivity {
    ...
    public void onEventMainThread(NotifacationMSG event) {
	...
	public class ChatAllHistoryAdapter extends ArrayAdapter<EMConversation> {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			if (convertView == null) {
				convertView = inflater.inflate(R.layout.row_chat_history,
						parent, false);
			}
			...
			if (isGroup) {
				...
				holder.name.setText(contact.getNick() != null ? contact
						.getNick() : username);
			} else {
