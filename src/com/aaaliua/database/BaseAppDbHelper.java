...
public class BaseAppDbHelper<T> {
	 ...
	 * @return
	 */
	synchronized public int deletelist(Class<T> c, String fieldName1,
			Object value1 ,String fieldName2,
			Object value2){
		BaseSQLiteHelperOrm db = new BaseAppSQLiteHelperOrm();
		try {
			Dao dao = db.getDao(c);
	...
	/** 查询一条记录 */
	synchronized public List<T> queryForEq(Class<T> c, String fieldName,
			Object value) {
		BaseSQLiteHelperOrm db = new BaseAppSQLiteHelperOrm();
		try {
			Dao dao = db.getDao(c);
	...
	/** 查询一个记录 */
	synchronized public T queryObjForEq(Class<T> c, String fieldName,
			Object value) {
		BaseSQLiteHelperOrm db = new BaseAppSQLiteHelperOrm();
		try {
			Dao dao = db.getDao(c);
	 ...
	 */
	synchronized public List<T> queryForNe(Class<T> c, String fieldName,
			Object value) {
		BaseSQLiteHelperOrm db = new BaseAppSQLiteHelperOrm();
		try {
			Dao dao = db.getDao(c);
	 ...
	 * @return
	 */
	synchronized public int update(Class<T> c, ContentValues values,
	 ...
	 * @return
	 */
	synchronized public List<T> queryFor2EqOrderBy(Class<T> c,
	 ...
	 * @return
	 */
	synchronized public T queryFor4(Class<T> c,
			String columnName1, Object value1, String columnName2,
			Object value2, String columnName3, Object value3,String columnName4, Object value4) {
		BaseSQLiteHelperOrm db = new BaseAppSQLiteHelperOrm();
		try {
			Dao dao = db.getDao(c);
			QueryBuilder queryBuilder = dao.queryBuilder();
			queryBuilder.where().eq(columnName1, value1).and()
			.eq(columnName2, value2).and().eq(columnName3, value3).and().eq(columnName4, value4);
	 ...
	 * @return
	 */
	synchronized public List<T> queryFor2Like(Class<T> c, String columnName1,
			Object value1, String columnName2, Object value2) {
		BaseSQLiteHelperOrm db = new BaseAppSQLiteHelperOrm();
		try {
			Dao dao = db.getDao(c);
			QueryBuilder queryBuilder = dao.queryBuilder();
			queryBuilder.where().like(columnName1, "%" + value1 + "%").or()
					.like(columnName2, value2 + "%");
			return queryBuilder.query();
		} catch (SQLException e) {
			// Logger.e(e);
		} finally {
	 ...
	 * <p>从两个相等中选一查询并排序<p>
	 * <p>类似于:</p>
	 * <p>WHERE columnName1 = 'value1' or columnName2 = 'value2' order by columnName value(DESC/ASC)</p>
	 * @param c
	 * @param columnName1
	 * @param value1
	 * @param columnName2
	 ...
	 * @return
	 */
	synchronized public List<T> queryForOr2EqOrderBy(Class<T> c,
			String columnName1, Object value1, String columnName2,
			Object value2, String columnName, Object value) {
		BaseSQLiteHelperOrm db = new BaseAppSQLiteHelperOrm();
		try {
			Dao dao = db.getDao(c);
			QueryBuilder queryBuilder = dao.queryBuilder();
			queryBuilder.where().eq(columnName1, value1).or()
					.eq(columnName2, value2);
			queryBuilder.orderByRaw(columnName + value);
			return queryBuilder.query();
		} catch (SQLException e) {
	...
	synchronized public List<T> queryOrderBy(Class<T> c, String columnName,
			Object value) {
		BaseSQLiteHelperOrm db = new BaseAppSQLiteHelperOrm();
		try {
			Dao dao = db.getDao(c);
